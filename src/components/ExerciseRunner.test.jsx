...
describe('ExerciseRunner Component', () => {
  beforeEach(() => {
    ...
    mockDbExec.mockImplementation((query) => {
      ...
      return createMockResults([], []); // Default empty result for other queries
    });
    mockDbRun.mockReturnValue(undefined); // Default for db.run
    // mockSqlJsDatabaseConstructor.mockClear(); // Already cleared by vi.clearAllMocks() for vi.fn()
  });
